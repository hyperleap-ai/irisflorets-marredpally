    ...
    <footer className="bg-purple-dark text-white">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {programs.map((program) => (
                <li key={program} className="text-sm text-white/80">
                  {program}
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <address className="space-y-3 text-sm not-italic text-white/80">
              <p>
                Plot No 26, Police Station Road,
                <br />
                Krishnapuri Colony, West Marredpally,
                <br />
        ...
        <div className="mt-10 border-t border-white/10 pt-6 text-center text-xs text-white/50">
          <p>
            &copy; {new Date().getFullYear()} Iris Florets Preschool,
            Marredpally. All rights reserved.
          </p>
          <p className="mt-1">
            A BITS Pilani &amp; IIM Alumni Initiative &middot; 100+ National &amp;
